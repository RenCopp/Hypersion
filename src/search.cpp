...
// 2026-05-18 Tier 3 v2 SPSA (nodes=500000) TC-MISMATCH RECORDED:
//   Bullet (5+0.05) 200g: +284.9 +/- 53.2 ELO (148W-13L-39D)
//   LTC    (60+0.6) 200g: -197.9 +/- 52.2 ELO (37W-140L-23D)
//   Net 483 ELO TC swing — the most extreme bullet:LTC mismatch in
//   Hypersion's history. The values appear to encode "depth ~17-22
//   move-ordering preferences" that ACTIVELY HURT deep search.
//   Defaults restored — Tier 3 v2 NOT shipped due to LTC catastrophe.
//   This invalidates the RETUNE_PLAN.md's central premise (nodes=500000
//   finds transferable optima). The retune plan needs reconsideration:
//   probably TC-mode SPSA at TC 60+0.6 (slow, but exact gradient match).
