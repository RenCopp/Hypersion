@echo off
REM Cumulative dev-main vs v1.0. Verifies the stack of 9 changes
REM accumulated on main (insufficient mat, searchmoves, bishop fix,
REM PSQT SIMD, UCI_ShowWDL, Hash 64MB default, Move Overhead 100ms
REM default, UCI_Variant, bench format) doesn't regress.
...
set OUTPGN=%~dp0ab_devmain_vs_v1.pgn
